...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [FN1] = LAYOUT_60_iso(
    ...
    _______, RGB_PLAIN_RED, KC_LEFT,   KC_DOWN,     KC_RGHT,   KC_ENT,   _______, KC_LEFT, KC_DOWN, KC_RGHT,   _______,    _______, _______, _______,
    _______, _______,       _______,   KC__VOLDOWN, KC__VOLUP, KC__MUTE, _______, _______, _______, _______,   _______,    _______, _______, _______,
