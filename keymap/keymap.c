...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [FN1] = LAYOUT_60_iso(
    ...
    RGB_TOG, RGB_MOD,   RGB_PLAIN_RED, _______,    _______,  _______, _______,  KC_PGUP, KC_UP,   KC_PGDOWN, KC_PSCREEN, _______, _______,
    _______, _______,   KC__VOLDOWN,   KC__VOLUP,  KC__MUTE, _______, _______,  KC_LEFT, KC_DOWN, KC_RGHT,   _______,    _______, _______, _______,
